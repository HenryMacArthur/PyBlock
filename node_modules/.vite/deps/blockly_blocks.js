...
var { blocks, lists, logic, loops, math, procedures, texts, variables, variablesDynamic } = (/* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(root, factory) {
		...
		blocks$$module$build$src$blocks$text.text_getSubstring = {
			init: function() {
				this.WHERE_OPTIONS_1 = [
					...
					[$.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_START_FIRST, "FIRST"]
				];
				this.WHERE_OPTIONS_2 = [
					[$.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_END_FROM_START, "FROM_START"],
					[$.Msg$$module$build$src$core$msg.TEXT_GET_SUBSTRING_END_FROM_END, "FROM_END"],
		...
		$.register$$module$build$src$core$extensions("math_op_tooltip", $.buildTooltipForDropdown$$module$build$src$core$extensions("OP", {
		...
		$.register$$module$build$src$core$extensions("controls_whileUntil_tooltip", $.buildTooltipForDropdown$$module$build$src$core$extensions("MODE", {
			WHILE: "%{BKY_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE}",
			UNTIL: "%{BKY_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL}"
		}));
		$.register$$module$build$src$core$extensions("controls_flow_tooltip", $.buildTooltipForDropdown$$module$build$src$core$extensions("FLOW", {
		...
		$.register$$module$build$src$core$extensions("logic_op_tooltip", $.buildTooltipForDropdown$$module$build$src$core$extensions("OP", {
				...
				this.setTooltip(() => {
					...
					switch (b + " " + c) {
						...
						case "REMOVE LAST":
							...
							break;
						case "REMOVE RANDOM": d = $.Msg$$module$build$src$core$msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM;
					}
				...
				this.setTooltip(() => {
					...
					switch (b + " " + c) {
						...
						case "INSERT LAST":
							...
							break;
						case "INSERT RANDOM": d = $.Msg$$module$build$src$core$msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM;
					}
		...
		blocks$$module$build$src$blocks$lists.lists_getSublist = {
			init: function() {
				this.WHERE_OPTIONS_1 = [
					...
					[$.Msg$$module$build$src$core$msg.LISTS_GET_SUBLIST_START_FIRST, "FIRST"]
				];
				this.WHERE_OPTIONS_2 = [
		...
		var module$build$src$blocks$blocks = {
...
//#endregion
export { blocks, lists, logic, loops, math, procedures, texts, variables, variablesDynamic };
